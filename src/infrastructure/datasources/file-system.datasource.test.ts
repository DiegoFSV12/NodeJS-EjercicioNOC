...
describe('FileSystemDatasource', () => {
    ...
    test('should save a log in log-all.log and logs-medium.log',()=>{
        const logDataSource = new FileSystemDatasource();
        const log = new LogEntity({
            message:'test',
    ...
    test('should save a log in log-all.log and logs-high.log',()=>{
        const logDataSource = new FileSystemDatasource();
        const log = new LogEntity({
            message:'test',
    ...
    test('should trow an error if severitylevel is not defined',async()=>{
        const logDatasource = new FileSystemDatasource();
        const customSeverityLevel = 'RANDOM' as LogSeverityLevel;
        try {
